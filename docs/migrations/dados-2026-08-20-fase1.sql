...
-- CORREÇÃO (incidente 19/08): os 4 índices de expressão sobre jsonb NÃO são criados aqui.
-- Eles ficam em `dados-2026-08-20-fase4-indices-pos-carga.sql`, aplicado DEPOIS da carga.
-- Motivo: com eles presentes, cada INSERT reavalia 4 extrações de jsonb e atualiza 5 árvores
-- de índice. Multiplicado por 83.778 linhas foi parte do que saturou a CPU em produção.
-- Criar depois do load é uma ordenação de magnitude mais barato.
